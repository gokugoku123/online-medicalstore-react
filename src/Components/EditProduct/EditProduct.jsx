            ...
            <div className="container border border-3 shadow p-4 rounded"  style={{width : "35rem", height : "auto", borderRadius : '10px', backgroundColor : "#cc9f9f", opacity : "0.9"}}>
                <form className="p-3 mx-auto" onSubmit={onSubmitHandler}>
                    ...
                    <div className="form-group mb-2 mt-4">
                        ...
                        <input type="text" className="form-control mb-1" id="productName" required aria-describedby="emailHelp" onChange={onChangeHandler} placeholder="Enter Product Name" value={state.productName}/>
                    </div>

                    <div className="form-floating mb-2 mt-4">
                        <textarea className="form-control mb-2" style={{height : "8rem"}} required value={state.description} onChange={onChangeHandler}  placeholder="Leave a comment here" id="description"></textarea>
                        <label htmlFor="description">Product Description</label>
                    </div>

                    <div className="form-group my-4">
                        <label htmlFor="price" className="mb-2">Price</label>
                        <input type="number" step="0.01" value="0.00" className="form-control mb-2" id="price" required aria-describedby="price" onChange={onChangeHandler} placeholder="Enter Price" value={state.price}/>
                    </div>
